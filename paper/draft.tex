...
While elemental abundance measurements from high resolution spectra of F, G, and K stars have achieved extremely high precisions (down to errors in the range of $0.01-0.03$\,dex; \citealt{Nissen2018}) enabled by the improvement of atmospheric models (citations),
the determination of precise metallicities for M dwarfs has remained a long standing challenge, due to the formation of complex molecular features at temperatures, particularly TiO and VO which dominate the optical, H$_2$O and CO which dominate the infrared, and hydride molecules (FeH, CaH, CrH, MgH, etc.) which form at late spectral types \citep{Allard1997}.
