...
The trained models are employed to determine spectral subtypes, temperatures and metallicities for 10,311 M dwarfs in \apogee.
...
\color{gcolor}{HOGG: grants etc}

\color{gcolor}{JB: SDSS acknowledgment}

\color{gcolor}{JB: Gaia acknowledgment}
