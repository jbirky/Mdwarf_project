...
\begin{center}
	...
	\caption{Metallicities of \cannon\ M dwarfs in binaries (x-axis) compared to the metallicities of their companions (y-axis). Label colors show the source and spectral type of the companion metallicities. Metallicity values for each binary pair is compiled in Table \ref{table:binaries}. }
\end{center}
\end{figure}
...
As an additional check of our metallicity consistency, we cross-matched our M dwarf final sample with the \citealt{Elbadry:2018b} catalog of $>$50,000 high-confidence, widely separated binaries identified by \drtwo. 
In total we found 230 of the \apogee\ M dwarfs to have binary pairs (XX FGK+M, XX M+M, and XX WD+M).
...
By contrast metallicities from ASPCAP show no significant difference in the distribution with an average thin disk metallicity of $\mh=-0.16\pm0.16\,$dex and an average thick disk metallicity of $\mh=-0.23\pm0.17\,$dex.
