...
\tablecaption{Strong $\teff$-correlated molecular lines for all features with significance greater than $2\sigma_{\rm jackknife}$. `Significance' quantifies the number of standard deviations that the derivative of the line is significant to (with negative corresponding to negative derivatives).}
