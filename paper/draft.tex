...
convection (\eg, \citealt{Behmard2019}).
It does not include any accounting for binarity or superposition of multiple
stellar spectra (as in, say, \citealt{ElBadry:2010}).
...
HOGG: Talk future work/implications with other stellar surveys (e.g. LAMOST), and exoplanet surveys (e.g. TESS)
