...
the determination of precise metallicities for M dwarfs has remained a long standing challenge, due to the formation of complex diatomic and triatomic molecular features at M dwarf temperature regimes, particularly TiO and VO which dominate the optical, H$_2$O and CO which dominate the infrared, and hydride molecules (FeH, CaH, CrH, MgH, etc.) which form at late spectral types \citep{Allard1997}.
