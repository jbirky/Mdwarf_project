...
%---------------------------
\begin{figure}[ht]
\plottwo{figures/test_cmd_chisq.png}{figures/test_fit_distribution.png}
\caption{The distribution of $\chi^2$ fits for all 14,827 sources in the APOGEE-Gaia cross match, with color cuts $1<G_{BP}-G_{RP}<6$ and $7.5<M_{G}<20$ and $\pi>0$. Note that there are $>$1,000 sources above the main sequence, many of which are pre-main sequence stars and main sequence binaries.}
\plottwo{figures/test_cmd_teff.png}{figures/test_cmd_feh.png}
\caption{Gaia color-magnitude diagram of 13,915 sources, selected with $\chi^2<200,000$ out of the total test sample.}
\end{figure}
